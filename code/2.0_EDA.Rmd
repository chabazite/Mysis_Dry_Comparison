...
for (AgeCategory in levels(growth_gemma_outlier_df$Age_Category)){
  ...
  QQPlot_AgeGroup <- ggplot(mapping = aes(sample =AgeGroup_df$Mass_mg)) + 
    ...
    labs(title = paste("Gemma Mass Normal Probabilty Plot: ", AgeCategory))
...
for (AgeCategory in levels(growth_mysis_outlier_df$Age_Category)){
  ...
  QQPlot_AgeGroup <- ggplot(mapping = aes(sample =AgeGroup_df$Mass_mg)) + 
    ...
    xlab("Normal N(0,1) Order Statistic Medians") +
    ylab("Ordered Response") + 
    labs(title = paste("Mysis Mass Normal Probabilty Plot: ", AgeCategory))
...
for (AgeCategory in levels(growth_gemma_outlier_df$Age_Category)){
  ...
  QQPlot_AgeGroup <- ggplot(mapping = aes(sample =AgeGroup_df$Length_mm)) + 
    ...
    xlab("Normal N(0,1) Order Statistic Medians") +
    ylab("Ordered Response") + 
    labs(title = paste("Gemma Length Normal Probabilty Plot: ", AgeCategory))
  print(QQPlot_AgeGroup)
  }
...
for (AgeCategory in levels(growth_mysis_outlier_df$Age_Category)){
  ...
  QQPlot_AgeGroup <- ggplot(mapping = aes(sample =AgeGroup_df$Length_mm)) + 
    ...
    xlab("Normal N(0,1) Order Statistic Medians") +
    ylab("Ordered Response") + 
    labs(title = paste("Mysis Length Normal Probabilty Plot: ", AgeCategory))
  print(QQPlot_AgeGroup)
  }
```
