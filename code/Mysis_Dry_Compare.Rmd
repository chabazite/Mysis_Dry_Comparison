...
#Same outlier dataframes for the Length
...
for (AgeCategory in growth_gemma_outlier_df$Age_Category){
  ...
  Mass_gemma_percentile_loc <-rbind(Mass_gemma_percentile_loc,temp_df)
  }
  
#percentile df of the outliers
mass_gemma_percentile_df <- growth_gemma_outlier_df[Mass_gemma_percentile_loc,]


mass_mysis_percentile_df <- growth_mysis_outlier_df[Mass_mysis_percentile_loc,]
...
## Condition Factor Outliers


```{r Condition Factor Outliers}
