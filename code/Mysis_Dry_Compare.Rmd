...
#shapiro wilk test if not significant (our case) tells us we can asusme normality
shapiro_test(model.metrics$.resid)

#now we figure equality of vareiance of the residuals using Leven's test for ANCOVA
