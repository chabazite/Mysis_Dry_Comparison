...
growth_mysis_outlier_df$Mass_Outlier<-as.integer(growth_mysis_outlier_df$Mass_Outlier)
growth_mysis_outlier_df$length_Outlier<-as.integer(growth_mysis_outlier_df$length_Outlier)

growth_mysis_outlier_df$Total_Outliers <-  growth_mysis_outlier_df %>%
 mutate(Total = select(., Mass_Outlier:length_Outlier) %>% rowSums(na.rm =TRUE))

ggplot(growth_mysis_outlier_df, aes(y=Mass_mg, x=Length_mm, color= Total_Outliers ))+geom_point()
