...
ggline(df_survival, x = "Date", y = "Census", add = "mean_se",
          color = "Feed_Group", palette = "jco") +
  stat_compare_means(aes(group = Feed_Group), label = "p.format")
...
ggbarplot(df_deaths, x = "Date", y = "Census_Dead", add = "mean_se",
          color = "Feed_Group", position = position_dodge(0.8))+
  stat_compare_means(aes(group = Feed_Group), label = "p.format")
...
ggboxplot(df_sex_tidy, x= "Sex", y="Percentage", color = "Feed_Group") +
  stat_compare_means(aes(group = Feed_Group),label = "p.format")
...
ggboxplot(df_fecundity, x= "Feed_Group", y="Viable_Embryos", color = "Feed_Group") +
  stat_compare_means()
